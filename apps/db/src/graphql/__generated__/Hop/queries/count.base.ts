...
export const countHopQueryObject = defineQueryFunction((t) =>
  defineQueryObject({
    type: 'Int',
    nullable: false,
    args: {
    ...
    resolve: async (_root, args, _context, _info) =>
      await _context.prisma.hop.count({
...
export const countHopQuery = defineQuery((t) => ({
  countHop: t.field(countHopQueryObject(t)),
}));
