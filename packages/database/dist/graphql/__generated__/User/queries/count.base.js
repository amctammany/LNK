...
export var countUserQueryObject = defineQueryFunction(function (t) {
    return defineQueryObject({
        type: 'Int',
        nullable: false,
        args: {
        ...
        resolve: function (_root, args, _context, _info) { return __awaiter(void 0, void 0, void 0, function () {
...
export var countUserQuery = defineQuery(function (t) { return ({
